...
catalog_version_date <- '2025-12-03'
ebi_catalog_version_date <- '2025-12-03'
fname_catalog_associations <-
  file.path(
    "data-raw",
    paste0("gwas_catalog_all_associations_",
           ebi_catalog_version_date,".zip"))
...
if (!file.exists(fname_catalog_associations)) {

  download.file(
    url = "https://www.ebi.ac.uk/gwas/api/search/downloads/associations/v1.0.2?split=false",
